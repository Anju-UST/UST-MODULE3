...
//post->->body il json object copy paste -> raw option created new object-->raw(option) then text to json from dropdown then run then send then true

@PutMapping
@RequestMapping(value="/update")
public Product updateProduct(@RequestBody Product product) {
	return service.updateProduct(product);//PUT in postman
}
