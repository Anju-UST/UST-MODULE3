...
public class ProductResource {
	...
	@ApiOperation(value="Accept and Return all the product entity ")
	...
	public ResponseEntity<?> addProduct(@RequestBody Product product) {
	 ...
	 service.updateProduct(product); }
	  ...
	  @ApiOperation(value="delete product entity ")
...
//run in browser for output --- localhost:8080/swagger-ui/index.html
